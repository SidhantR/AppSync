...
exports.graphQlError = (data) => {
    switch (data) {
        case CONSTANTS.ERRORS.USER_EXIST.MESSAGE:
            throw new GraphQLError(CONSTANTS.ERRORS.USER_EXIST.MESSAGE, {
                extensions: {
                    code: CONSTANTS.ERRORS.USER_EXIST.CODE,
                }
            });
        case CONSTANTS.ERRORS.USER_ID_REQUIRED.MESSAGE:
            throw new GraphQLError(CONSTANTS.ERRORS.USER_ID_REQUIRED.MESSAGE, {
                extensions: {
                    code: CONSTANTS.ERRORS.USER_ID_REQUIRED.CODE,
                },
            });
        case CONSTANTS.ERRORS.USER_NOT_EXIST.MESSAGE:
